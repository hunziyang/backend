package com.techking.portal.core.log;
...
public class LogFilter extends OncePerRequestFilter {
    ...
    private boolean shouldSkip(HttpServletRequest httpServletRequest) {
        ...
        if (httpServletRequest.getRequestURI().contains("/webjars")) {
            return true;
        }
        if (httpServletRequest.getRequestURI().contains("/v2/api-docs")) {
            return true;
        }
        if (httpServletRequest.getRequestURI().contains("/swagger-resources")) {
            return true;
        }
        return false;
    }
